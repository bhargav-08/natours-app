    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Unable to logged out!!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmhhcmdhdjA4IiwiYSI6ImNsaWVodjhoNTA1cHQzZW1yMjQydmE1NzUifQ.ek-rbuk1_06SE21EuPpZhQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bhargav08/cliei8l8s001k01qpc2vh6e26',
    scrollZoom: false // interactive:false // set this map as picture
    // zoom:11
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Create Popup and attached to map
...
if (updateUserData) {
  updateUserData.addEventListener('submit', function (event) {
    event.preventDefault();
...
if (updateUserPassword) {
  updateUserPassword.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    _regeneratorRuntime().mark(function _callee(event) {
      var saveBtn, password, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
...
},{"./login":"login.js","./map":"map.js","./updateSetting":"updateSetting.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
